...
.my-text{
 ...
 <body>
 	<div class="view" style="background-image: url('images/rade2.jpg'); background-repeat: no-repeat;background-size: cover; background-position: center center;
 		<div class="container my-container">
 			...
 			<div class="row justify-content-around my-row">
 				...
 				<br>
 				<p class="text-center my-text"> Records en kayak </p>
 				<br>
 				...
 				<br>
 				<p class="text-center my-text"> Records en planche à voile </p>
 				<br>
 				<p class="text">BLABLAPHP</p>	
 				</div>
 				...
 				<br>
 				<p class="text-center my-text"> Records en kitesurf </p>
 				<br>
 				<p class="text">BLABLAPHP</p>	
 				</div>
 			...
 			<div class="row my-row">
 				...
 				<br>
 				<p class="text-center my-text"> Records en paddle </p>
 				<br>
 				<p class="text">BLABLAPHP</p>	
 				</div>
 				...
 				<br>
 				<p class="text-center my-text"> Records en voile </p>
 				<br>
 				<p class="text">BLABLAPHP</p>	
 				</div>
