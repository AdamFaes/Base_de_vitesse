            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    ...
                    <div class="description">
                      <p>
                        Consulte, enregistre et participe à des compétitions en temps réel !
                      </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                  <div class="form-top">
                    <div class="form-top-left">
                      <h3>Inscris toi au site pour participer !</h3>
                        <p>Remplis les informations suivantes pour continuer :</p>
                    </div>
                  ...
                  <form role="form" action="" method="post" class="login-form">
                    <div class="form-group">
                      <label class="sr-only" for="nom">Last Name</label>
                        <input type="text" name="nom" placeholder="Nom de famille" class="form-lastname form-control" id="inputLastName">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="mail" placeholder="Adresse Mail" class="form-mail form-control" id="inputMail">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" name="pass2" placeholder="Confirmez votre mot de passe" class="form-password2 form-control" id="inputPassword2">
                      </div>
                      <div class="form-group">
